...
print(f'American Call price: {resultbc.price_american():.4f}') #Added for completleness, in reality never optimal to exit early
...
VolSmile(Testc, strikes, market_prices).plot_market_smile('AAPL', '2026-09-18')
print('\n===Convergence Plots===')
